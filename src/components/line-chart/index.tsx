...
export default class LineChart extends React.Component<any> {
  ...
  componentDidMount() {
    ...
    const data = this.props.data.y;
    const option = this.getOption(x, data);
  ...
  componentWillReceiveProps(nextProps) {
    const x = nextProps.data.x;
    const y = nextProps.data.y;
  ...
  render() {
    return <div style={{ width: this.props.style.width || '100%', height: this.props.style.height || '100%' }} ref={domContainer => this.domContainer = domContainer} />
  }
}
